    ...
    <div className="flex items-center justify-center">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white px-8 py-10 shadow-sm">
        ...
        <form className="space-y-4">
          ...
          <button
            type="submit"
            className="mt-2 w-full rounded-lg bg-[var(--v2-primary)] py-2.5 text-sm font-medium text-[var(--v2-primary-foreground)] shadow-sm transition hover:bg-[var(--v2-primary-hover)]"
          >
            Sign In
          </button>
        </form>
        ...
        <p className="mt-6 text-center text-xs text-slate-500">
          ...
          <Link href="/v2/signup" className="font-medium text-slate-900 underline-offset-2 hover:underline">
            Sign Up
          </Link>
        </p>
      </div>
