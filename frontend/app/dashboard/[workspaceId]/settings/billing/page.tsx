...
export default function WorkspaceSettingsBillingPage() {
  ...
  const planName = currentWorkspace?.id === workspaceId
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="mx-auto max-w-2xl space-y-8">
            ...
            <div className="mt-3 flex items-center justify-between rounded-lg border border-slate-100 bg-slate-50/50 px-4 py-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-slate-600">
                  {planName === 'free' ? 'Free tier — upgrade for more' : 'Active subscription'}
                </span>
              </div>
              {isOwner && (
                <Link
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-1 text-xs text-slate-500">
              Invoices and payment history. Available after your first charge.
            </p>
            <div className="mt-4 rounded-lg border border-slate-100 bg-slate-50/30 px-4 py-6">
              ...
              <p className="mt-2 text-xs text-slate-500">
                When you upgrade, invoices will appear here and can be downloaded.
              </p>
            </div>
          </section>
        </div>
