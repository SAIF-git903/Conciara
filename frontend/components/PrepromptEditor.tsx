...
export default function PrepromptEditor({ preprompt, onSave, loading, readOnly = false }: PrepromptEditorProps) {
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        <div className="flex items-center justify-between mt-3">
          <p className="text-xs text-gray-400">
            {readOnly ? 'View-only mode' : 'System message for all conversations'}
          </p>
          {!readOnly && (
            <button
              onClick={handleSave}
