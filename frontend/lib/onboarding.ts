/** Keys used during onboarding to pass workspace/agent between steps */

export const ONBOARDING_WORKSPACE_KEY = 'onboarding_workspace_id'
export const ONBOARDING_AGENT_KEY = 'onboarding_agent_id'
export const ONBOARDING_LINK_DONE_KEY = 'onboarding_link_done'
...
export function resetOnboardingAndGoToWorkspace(router: { replace: (url: string) => void }): void {
  clearOnboardingKeys()
  router.replace('/onboarding/workspace?session=reset')
}
