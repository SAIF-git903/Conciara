...
/** Shared: run SSE stream for agent chat. Used by both auth and public-embed routes. */
...
/** Public embed: handle chat stream. Used by server.ts. Embedding implies public access. */
